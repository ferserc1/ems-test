...
var Module = typeof FibModule !== 'undefined' ? FibModule : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fib')) {
        Object.defineProperty(Module['ready'], '_fib', { configurable: true, get: function() { abort('You are getting _fib on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fib', { configurable: true, set: function() { abort('You are setting _fib on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_fib2')) {
        Object.defineProperty(Module['ready'], '_fib2', { configurable: true, get: function() { abort('You are getting _fib2 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_fib2', { configurable: true, set: function() { abort('You are setting _fib2 on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_printString')) {
        Object.defineProperty(Module['ready'], '_printString', { configurable: true, get: function() { abort('You are getting _printString on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_printString', { configurable: true, set: function() { abort('You are setting _printString on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_getArrayTest')) {
        Object.defineProperty(Module['ready'], '_getArrayTest', { configurable: true, get: function() { abort('You are getting _getArrayTest on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_getArrayTest', { configurable: true, set: function() { abort('You are setting _getArrayTest on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _fib2 = Module["_fib2"] = createExportWrapper("fib2");
...
/** @type {function(...*):?} */
var _getArrayTest = Module["_getArrayTest"] = createExportWrapper("getArrayTest");
...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return FibModule; });
else if (typeof exports === 'object')
  exports["FibModule"] = FibModule;
